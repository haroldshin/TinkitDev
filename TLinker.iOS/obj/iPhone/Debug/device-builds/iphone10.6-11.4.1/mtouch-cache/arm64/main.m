...
extern void *mono_aot_module_TLinker_iOS_info;
...
extern void *mono_aot_module_TLinker_info;
...
{
	mono_aot_register_module (mono_aot_module_TLinker_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_TLinker_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "TLinker.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
